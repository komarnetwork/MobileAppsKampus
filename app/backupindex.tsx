...
import { Text, View, Image, ScrollView, TextInput, Button, FlatList, TouchableOpacity } from 'react-native';
  ...
  return (
    <ScrollView>
      <View className='flex-1 items-center justify-center px-5'>
        <Text className='text-3xl font-bold underline text-blue-500 p-5'>
          React Native Komponen Dasar
        </Text>
        ...
        <Button
          ...
          onPress={() =>
            setMessage(`Hello ${name}, selamat belajar ReactNative`)
          }
        />

        {message ? (
          <Text className='font-bold text-lg text-green-600 p-5'>
            {message}
          </Text>
        ) : null}
