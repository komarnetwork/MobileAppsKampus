...
export default function LuasSegitiga() {
  ...
  return (
    <View className='flex-1 items-center px-5'>
      <Text className='text-3xl font-bold text-center underline text-blue-500 p-5'>Tugas 3 - Hitung Luas Segitiga</Text>

      <Image className='w-20 h-20' source={{ uri: 'https://reactnative.dev/img/tiny_logo.png' }} />

      <Text className='text-center text-2xl mt-5'>Halo, selamat datang di aplikasi React Native menggunakan Expo!</Text>
      ...
      <Pressable className='bg-blue-500 rounded-xl py-3 px-10 mt-4' onPress={hitungLuas}>
        <Text className='text-white text-center font-bold'>Tampilkan Hasil</Text>
      </Pressable>
