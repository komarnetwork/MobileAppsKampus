  ...
  return (
    <View className='flex-1 items-center justify-center'>
      ...
      <View className='w-full p-5 items-center justify-center'>
        <Pressable
          onPress={() => router.push('./modul9/counterApp')}
          className='bg-blue-500 shadow shadow-slate-400 rounded-xl p-3 w-50 mt-4'
        >
          <Text className='text-white text-center'>Counter Count</Text>
        </Pressable>

        <Pressable
          onPress={() => router.push('./modul9/DataFetcher')}
          className='bg-blue-500 shadow shadow-slate-400 rounded-xl p-3 w-50 mt-4'
        >
          <Text className='text-white text-center'>Data Fetcher</Text>
        </Pressable>
      </View>
